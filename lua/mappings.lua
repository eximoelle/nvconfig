...
map("t", "<c-h>", "<Cmd>lua vim.cmd('wincmd h')<CR>", { desc = "Move to left window", silent = true })
map("t", "<c-j>", "<Cmd>lua vim.cmd('wincmd j')<CR>", { desc = "Move to lower window", silent = true })
map("t", "<c-k>", "<Cmd>lua vim.cmd('wincmd k')<CR>", { desc = "Move to upper window", silent = true })
map("t", "<c-l>", "<Cmd>lua vim.cmd('wincmd l')<CR>", { desc = "Move to right window", silent = true })
map("t", "<C-z>", "<Cmd>stopinsert<CR>", { desc = "Escape Terminal" })
-- Basic
